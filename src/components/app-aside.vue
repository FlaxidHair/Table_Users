<template>
  <div id="app">
    <v-navigation-drawer v-show="$store.state.isShow" stateless value="true">
      <v-list d-flex>
        <v-list-group value="true" active-class="de">
          <template v-slot:activator>
            <v-list-tile>
              <v-list-tile-title>Профили</v-list-tile-title>
            </v-list-tile>
          </template>
          <v-card class="mx-auto" max-width="300" tile height="90vh">
